...
namespace Paghiper.Infra.Sqlite.Migrations
{
    ...
    [Migration("20210726013715_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PagHiper.Domain.Entities.Aluno", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PagHiper.Domain.Entities.AlunoContato", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PagHiper.Domain.Entities.AlunoMatricula", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PagHiper.Domain.Entities.AlunoParcelas", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PagHiper.Domain.Entities.AlunoTurma", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PagHiper.Domain.Entities.Endereco", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PagHiper.Domain.Entities.AlunoContato", b =>
                {
                    b.HasOne("PagHiper.Domain.Entities.Aluno", null)
                        .WithMany("Contatos")
            ...
            modelBuilder.Entity("PagHiper.Domain.Entities.AlunoMatricula", b =>
                {
                    b.HasOne("PagHiper.Domain.Entities.Aluno", null)
                        .WithOne("Matricula")
                        .HasForeignKey("PagHiper.Domain.Entities.AlunoMatricula", "AlunoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PagHiper.Domain.Entities.AlunoParcelas", b =>
                {
                    b.HasOne("PagHiper.Domain.Entities.Aluno", null)
                        .WithOne("Parcelas")
                        .HasForeignKey("PagHiper.Domain.Entities.AlunoParcelas", "AlunoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("PagHiper.Domain.Entities.Endereco", b =>
                {
                    b.HasOne("PagHiper.Domain.Entities.Aluno", null)
                        .WithOne("Endereco")
                        .HasForeignKey("PagHiper.Domain.Entities.Endereco", "AlunoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
